...
const resolvers = {
    ...
    Mutation: {
        ...
        createAuthCode: (_, { userId, name, email }) => authCodeModel.create(userId, name, email),
        // Resolver para actualizar un authCode existente
        updateAuthCode: (_, { id, userId, name, email }) => authCodeModel.update(id, userId, name, email),
